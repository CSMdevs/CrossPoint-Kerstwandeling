...
function oa(a) {
    if (!pa.test(a)) return a; - 1 != a.indexOf("\x26") && (a = a.replace(qa, "\x26amp;")); - 1 != a.indexOf("\x3c") && (a = a.replace(ra, "\x26lt;")); - 1 != a.indexOf("\x3e") && (a = a.replace(sa, "\x26gt;")); - 1 != a.indexOf('"') && (a = a.replace(ta, "\x26quot;")); - 1 != a.indexOf("'") && (a = a.replace(ua, "\x26#39;")); - 1 != a.indexOf("\x00") && (a = a.replace(va, "\x26#0;"));
    return a
}
var qa = /&/g,
    ra = /</g,
...
var Ka = y("Opera") || y("OPR"),
    z = y("Trident") || y("MSIE"),
    A = y("Edge"),
    B = y("Gecko") && !(-1 != Ba.toLowerCase().indexOf("webkit") && !y("Edge")) && !(y("Trident") || y("MSIE")) && !y("Edge"),
    C = -1 != Ba.toLowerCase().indexOf("webkit") && !y("Edge"),
    D = y("Macintosh"),
    La = y("Windows"),
    Ma = y("Linux") || y("CrOS");
...
var Ra = l.document,
    F = Ra && z ? Oa() || ("CSS1Compat" == Ra.compatMode ? parseInt(Pa, 10) : 5) : void 0;
var Sa = !z || 9 <= Number(F);
...
I.prototype.getTile = function(a, b) {
    ...
    if (this.minZoom <= b && b <= this.maxZoom && 0 <= e && e < c && this.bounds.intersects(this.gc(b, d, e))) {
        ...
        else var g = Math.pow(2, b - this.rb),
            c = Math.floor(d / g),
            h = Math.floor(e / g),
            k = 256 * (d - g * c) / g,
            r = 256 * (e - g * h) / g,
...
J.prototype.D = function() {
    if (!this.qa && (this.qa = !0, this.g(), 0 != tb)) {
        var a = ga(this);
        delete ub[a]
    }
};
...
f.add = function(a, b, c, d, e) {
    ...
    var h = Hb(a, b, d, e); - 1 < h ? (b = a[h], c || (b.Oa = !1)) : (b = new Eb(b, this.src, g, !!d, e), b.Oa = c, a.push(b));
    return b
};
...
function Hb(a, b, c, d) {
    for (var e = 0; e < a.length; ++e) {
        var g = a[e];
        if (!g.va && g.listener == b && g.ya == !!c && g.Wa == d) return e
    }
    return -1
};
...
function Rb(a, b, c, d, e) {
    if (n(b))
        for (var g = 0; g < b.length; g++) Rb(a, b[g], c, d, e);
    else c = Mb(c), a && a[Cb] ? a.Na(b, c, d, e) : a && (a = Nb(a)) && (b = a.Ca(b, c, !!d, e)) && N(b)
}
...
function N(a) {
    if (!q(a) && a && !a.va) {
        ...
        if (b && b[Cb]) Ib(b.T, a);
            ...
            var c = a.type,
                d = a.eb;
            b.removeEventListener ? b.removeEventListener(c, d, a.ya) : b.detachEvent && b.detachEvent(Pb(c), d);
            Lb--;
    ...
    if (a = Nb(a))
        if (b = a.u[b.toString()])
            for (b = b.concat(), a = 0; a < b.length; a++) {
                var g = b[a];
                g && g.ya == c && !g.va && (g = Tb(g, d), e = e && !1 !== g)
            }
        return e
}
...
function Qb(a, b) {
    ...
    if (!yb) {
        ...
        if (!(0 > e.keyCode || void 0 != e.returnValue)) {
            ...
            for (var g = a.type, h = e.length - 1; !c.na && 0 <= h; h--) {
                c.currentTarget = e[h];
                var k = Sb(e[h], g, !0, c),
                    d = d && k
            }
...
f.dispatchEvent = function(a) {
    ...
    var e = !0,
        g;
    if (b)
        for (var h = b.length - 1; !a.na && 0 <= h; h--) g = a.currentTarget = b[h], e = Vb(g, d, !0, a) && e;
    a.na || (g = a.currentTarget = c, e = Vb(g, d, !0, a) && e, a.na || (e = Vb(g, d, !1, a) && e));
    if (b)
        for (h = 0; !a.na && h < b.length; h++) g = a.currentTarget = b[h], e = Vb(g, d, !1, a) && e;
    return e
};
f.g = function() {
    O.i.g.call(this);
    this.T && this.T.ua(void 0);
    this.cb = null
};
...
f.sc = function() {
    if (this.enabled) {
        var a = u() - this.ob;
        0 < a && a < .8 * this.ia ? this.M = this.wa.setTimeout(this.hb, this.ia - a) : (this.M && (this.wa.clearTimeout(this.M), this.M = null), this.dispatchEvent("tick"), this.enabled && (this.M = this.wa.setTimeout(this.hb, this.ia), this.ob = u()))
    }
};
f.start = function() {
    this.enabled = !0;
    this.M || (this.M = this.wa.setTimeout(this.hb, this.ia), this.ob = u())
};
f.stop = function() {
    this.enabled = !1;
    this.M && (this.wa.clearTimeout(this.M), this.M = null)
};
f.g = function() {
    Wb.i.g.call(this);
    this.stop();
...
f.mb = function(a) {
    if (C || A)
        if (17 == this.H && !a.ctrlKey || 18 == this.H && !a.altKey || D && 91 == this.H && !a.metaKey) this.da = this.H = -1; - 1 == this.H && (a.ctrlKey && 17 != a.keyCode ? this.H = 17 : a.altKey && 18 != a.keyCode ? this.H = 18 : a.metaKey && 91 != a.keyCode && (this.H = 91));
    hc && !ac(a.keyCode, this.H, a.shiftKey, a.ctrlKey, a.altKey) ? this.handleEvent(a) : (this.da = cc(a.keyCode), ic && (this.gb = a.altKey))
};
f.hc = function(a) {
    this.da = this.H = -1;
    this.gb = a.altKey
...
f.handleEvent = function(a) {
    var b = a.U,
        c, d, e = b.altKey;
    z && "keypress" == a.type ? (c = this.da, d = 13 != c && 27 != c ? b.keyCode : 0) : (C || A) && "keypress" == a.type ? (c = this.da, d = 0 <= b.charCode && 63232 > b.charCode && bc(c) ? b.charCode : 0) : Ka && !C ? (c = this.da, d = bc(c) ? b.keyCode : 0) : (c = b.keyCode || this.da, d = b.charCode || 0, ic && (e = this.gb), D && 63 == d && 224 == c && (c = 191));
    var g = c = cc(c),
        h = b.keyIdentifier;
...
function kc(a, b) {
    O.call(this);
    var c = this.h = a,
        c = fa(c) && 1 == c.nodeType ? this.h : this.h ? this.h.body : null;
    this.nc = !!c && mb(c);
...
nc.prototype.play = function(a) {
    ...
    if (a || this.f == Q) this.kb = 0, this.bb();
    else if (1 == this.f) return !1;
    this.v("play"); - 1 == this.f && this.v("resume");
    var b = -1 == this.f && !a;
    this.startTime = u();
    this.endTime = null;
    this.f = 1;
...
nc.prototype.Rb = function() {
    this.kb++;
    this.kb == this.S.length && (this.endTime = u(), this.f = Q, this.v("finish"), this.ta())
};
...
f.l = function(a, b, c, d) {
    ...
    for (var e = 0; e < b.length; e++) {
        var g = M(a, b[e], c || this.handleEvent, d || !1, this.Ea || this);
        if (!g) break;
        this.Ga[g.key] = g
    }
    return this
...
f.Na = function(a, b, c, d, e) {
    if (n(b))
        for (var g = 0; g < b.length; g++) this.Na(a, b[g], c, d, e);
    else c = c || this.handleEvent, e = e || this.Ea || this, c = Mb(c), d = !!d, b = a && a[Cb] ? a.Ca(b, c, d, e) : a ? (a = Nb(a)) ? a.Ca(b, c, d, e) : null : null, b && (N(b), delete this.Ga[b.key]);
    return this
};
f.ua = function() {
    Ea(this.Ga, function(a, b) {
        this.Ga.hasOwnProperty(b) && N(a)
    }, this);
    this.Ga = {}
};
f.g = function() {
...
function qc(a) {
    ...
    if (B) var d = pb(c),
        b = b + d.left;
    else 8 <= Number(F) && !(9 <= Number(F)) && (d = pb(c), b -= d.left);
...
function rc(a, b, c) {
    ...
    this.R = new oc(this);
    a = la(vb, this.R);
    this.qa ? a.call(void 0) : (this.la || (this.la = []), this.la.push(m(void 0) ? t(a, void 0) : a));
...
f.Ub = function(a) {
    ...
    if (!this.Ta || this.fa || b && (!(xb ? 0 == a.U.button : "click" == a.type || a.U.button & Bb[0]) || C && D && a.ctrlKey)) this.dispatchEvent("earlycancel");
    else {
        if (0 == this.Hb)
            if (this.dispatchEvent(new uc("start", this, a.clientX, a.clientY))) this.fa = !0, this.Sb && a.preventDefault();
            else return;
        else this.Sb && a.preventDefault();
        var b = this.w,
            c = b.documentElement,
            d = !sc;
        ...
        this.deltaX = this.oa ? qc(this.target) : this.target.offsetLeft;
...
f.Ua = function(a) {
    this.R.ua();
    sc && this.w.releaseCapture();
    this.fa ? (this.fa = !1, this.dispatchEvent(new uc("end", this, a.clientX, a.clientY, 0, vc(this, this.deltaX), wc(this, this.deltaY)))) : this.dispatchEvent("earlycancel")
};
f.jc = function(a) {
    if (this.Ta) {
        var b = (this.oa && tc(this) ? -1 : 1) * (a.clientX - this.clientX),
        ...
        if (!this.fa) {
            ...
            if (d * d + e * e > this.Hb)
                if (this.dispatchEvent(new uc("start", this, a.clientX, a.clientY))) this.fa = !0;
                else {
                    this.qa || this.Ua(a);
                    return
                }
        ...
        b = c.x;
        c = c.y;
        this.fa && this.dispatchEvent(new uc("beforedrag", this, a.clientX, a.clientY, 0, b, c)) &&
...
f.ib = function(a, b) {
    this.oa && tc(this) ? this.target.style.right = a + "px" : this.target.style.left = a + "px";
...
f.play = function(a) {
    if (a || this.f == Q) this.K = 0, this.coords = this.Ka;
    else if (1 == this.f) return !1;
    Bc(this);
    this.startTime = a = u(); - 1 == this.f && (this.startTime -= this.duration * this.K);
...
function Ec(a, b) {
    ...
    1 <= a.K && (a.K = 1);
    Gc(a, a.K);
    1 == a.K ? (a.f = Q, Bc(a), a.v("finish"), a.ta()) : 1 == a.f && a.sb()
}
...
Ic.prototype.xa = function() {
    var a = this.oa && this.ja() ? "right" : "left";
...
f.ub = function(a) {
    if (this.Ha && this.Ha != a) throw Error("Method not supported");
    W.i.ub.call(this, a)
};
f.lb = function() {
    return this.ra
...
f.za = function() {
    this.h = this.ra.createElement("DIV")
};
...
f.g = function() {
    this.ha && this.Ba();
    this.ba && (this.ba.D(), delete this.ba);
    Nc(this, function(a) {
        a.D()
    });
    !this.Zb && this.h && db(this.h);
    this.Ha = this.h = this.Qa = this.Ra = null;
    W.i.g.call(this)
};
f.ja = function() {
    null == this.X && (this.X = mb(this.ha ? this.h : this.ra.w.body));
    return this.X
};
...
f.ea = function(a) {
    a = X(this, a);
    this.pa != a && (this.pa = a + this.F > this.J ? this.J - this.F : a < this.N ? this.N : a, this.B || this.ka || this.dispatchEvent("change"))
};
f.s = function() {
    return X(this, this.pa)
};
f.Ia = function(a) {
    a = X(this, a);
    this.F != a && (this.F = 0 > a ? 0 : this.pa + a > this.J ? this.J - this.pa : a, this.B || this.ka || this.dispatchEvent("change"))
};
f.V = function() {
    var a = this.F;
...
f.fb = function(a) {
    if (this.N != a) {
        ...
        a > this.pa && this.ea(a);
        a > this.J && (this.F = 0, this.Ja(a), this.ea(a));
        (this.B = b) || this.ka || this.dispatchEvent("change")
    }
};
f.o = function() {
...
f.Ja = function(a) {
    ...
    if (this.J != a) {
        ...
        this.B = !0;
        this.J = a;
        a < this.pa + this.F && this.ea(a - this.F);
        a < this.N && (this.F = 0, this.fb(a), this.ea(this.J));
...
f.vb = function(a) {
    this.Y != a && (this.Y = a, a = this.B, this.B = !0, this.Ja(this.m()), this.Ia(this.V()), this.ea(this.s()), (this.B = a) || this.ka || this.dispatchEvent("change"))
};
...
f.za = function() {
    Y.i.za.call(this);
    var a = this.lb().za("DIV", Pc(this.C));
    this.Sa(a)
};
f.Sa = function(a) {
    Y.i.Sa.call(this, a);
    ...
    b = b[0];
    b || (b = this.lb().za("DIV", "goog-slider-thumb"),
...
f.Va = function() {
    ...
    this.aa = new rc(this.A);
    this.O.$(this.G);
    this.aa.$(this.G);
    this.O.ib = this.aa.ib = aa;
    this.Fa = new ec(this.b());
    this.ga().l(this.O, "beforedrag", this.Cb).l(this.aa, "beforedrag", this.Cb).l(this.O, ["start", "end"], this.Fb).l(this.aa, ["start", "end"], this.Fb).l(this.Fa, "key", this.mb).l(this.b(), "click", this.Db).l(this.b(), "mousedown", this.Db);
    this.mc && (this.sa || (this.sa = new kc(this.b())), this.ga().l(this.sa, "mousewheel", this.ic));
    this.b().tabIndex = 0;
    Rc(this)
};
f.Ba = function() {
    Y.i.Ba.call(this);
    wb(this.O, this.aa, this.Fa, this.sa)
};
f.Cb = function(a) {
    var b = a.jb == this.O ? this.a : this.A,
        c;
...
f.Xb = function() {
    ...
    var a = H(this.b());
    this.ga().Na(a, "mouseup", this.Xb, !0).Na(this.b(), "mousemove", this.wb)
};
...
function Yc(a, b) {
    ...
    return "vertical" == a.C ? c.y : a.G && a.ja() ? a.b().clientWidth - c.x : c.x
}
f.wb = function(a) {
    this.$a = Yc(this, a)
};
...
function Zc(a, b, c) {
    a.o() <= b && b <= a.m() - c && a.ab <= c && c <= a.m() - b && (b != a.s() || c != a.V()) && (a.c.ka = !0, a.c.Ia(0), a.c.ea(b), a.c.Ia(c), a.c.ka = !1, a.Eb())
}
f.o = function() {
    return this.c.o()
};
...
function Rc(a) {
    if (a.a && !a.Xa) {
        var b = $c(a, Z(a, a.a)),
            c = $c(a, Z(a, a.A));
        if ("vertical" == a.C) a.a.style.top = b.y + "px", a.A.style.top = c.y + "px", a.j && (b = ad(c.y, b.y, a.a.offsetHeight), a.j.style.top = b.offset + "px", a.j.style.height = b.size + "px");
        else {
            var d = a.G && a.ja() ? "right" : "left";
            a.a.style[d] = b.x + "px";
            a.A.style[d] = c.x + "px";
...
f.setOrientation = function(a) {
    if (this.C != a) {
        var b = Pc(this.C),
            c = Pc(a);
        this.C = a;
        this.b() && (a = this.b(), Yb(a, b) && ($b(a, b), Zb(a, c)), b = this.G && this.ja() ? "right" : "left", this.a.style[b] = this.a.style.top = "", this.A.style[b] = this.A.style.top = "", this.j && (this.j.style[b] = this.j.style.top = "", this.j.style.width = this.j.style.height = ""), Rc(this))
    }
};
f.g = function() {
    Y.i.g.call(this);
    ...
    this.c.D();
    delete this.c;
    this.Fa && (this.Fa.D(), delete this.Fa);
    this.sa && (this.sa.D(), delete this.sa);
...
function dd(a, b, c) {
    ...
    a = $a("div", {
        style: "margin:5px;overflow:hidden;background:url(https://cdn.klokantech.com/maptilerlayer/v1/opacity-slider.png) no-repeat;width:71px;height:21px;cursor:pointer"
    });
    this.I = new cd;
...
function ed(a) {
    if (navigator.geolocation) {
        var b = !a.enabled;
        b ? (a.Pa = !0, a.xb = !!a.yb, a.ma ? a.ma.getPosition().equals(new google.maps.LatLng(0, 0)) || a.ma.setVisible(!0) : a.ma = new google.maps.Marker({
            clickable: !1,
            ...
            visible: !1
        }), a.Z ? a.Z.getCenter().equals(new google.maps.LatLng(0, 0)) || a.Z.setVisible(!0) : a.Z = new google.maps.Circle({
            clickable: !1,
            strokeColor: "#3a84df",
            strokeOpacity: .8,
            strokeWeight: .5,
            ...
            radius: 1,
            visible: !1
        }), a.Bb || (a.Bb = navigator.geolocation.watchPosition(t(function(a) {
            if (this.enabled) {
                var b = new google.maps.LatLng(a.coords.latitude, a.coords.longitude);
                this.ma.setPosition(b);
                this.ma.setVisible(!0);
                this.Z.setCenter(b);
                this.Z.setRadius(a.coords.accuracy);
                this.Z.setVisible(!0);
                this.Pa && (this.map.setCenter(b), this.Pa = !0);
                this.xb && this.yb && (this.map.setZoom(this.yb), this.xb = !1)
            }
        }, a), void 0, {
            enableHighAccuracy: !0
        }))) : (a.ma.setVisible(!1), a.Z.setVisible(!1));
...
v("klokantech.GeolocationControl", function(a, b, c) {
    this.map = a;
    navigator.geolocation && "https:" == location.protocol && (this.Ib = $a("div", {
        style: "background-size:36px 18px;width:18px;height:18px;opacity:0.9;background-image:url(https://cdn.klokantech.com/maptilerlayer/v1/geolocation.png);",
        id: "geolocationIcon"
    }), this.element = $a("div", {
            style: "background-color:#fff;border:2px solid #fff;border-radius 3px;box-shadow:rgba(0,0,0,0.298039) 0 1px 4px -1px;margin-right:10px;cursor:pointer;border-radius:2px;padding:3px;",
            id: "geolocationBtn"
        },
